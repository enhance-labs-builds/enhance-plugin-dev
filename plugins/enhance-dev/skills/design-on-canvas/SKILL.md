...
1. Read the brief, canvas structure, current prototype, relevant captured screens, reusable components, styles, and tokens. For an existing product, derive its language rather than substituting generic UI.
